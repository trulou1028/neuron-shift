...
- **Learning layer.** A personal onboarding overlay in its own color, off by default. Real operators already know this material, so it is deliberately layered on rather than built in.
